...
const sections = [
  ...
  },
  {
    ...
    num: "04",
    title: "关系经营 · 社会教育",
    subtitle: "补上传统教育缺少的一课",
    audience: "职场新人 · 婚恋家庭 · 希望改善人际与协作的人",
    points: [
      {
        label: "为何需要",
        text: "传统教育重知识轻社会：很少系统教授如何处理与领导、伴侣、同事的关系。启明把它当作可学习的社会技能。",
      },
      {
        label: "四大课题",
        text: "婚恋家庭、职场上下级、信任博弈与合作、自我认知与心理素养——整合既有专栏文稿。",
      },
      {
        label: "社群练习",
        text: "在「关系经营社群」讨论真实场景，互加好友，把阅读变成可练习的连接。",
      },
      {
        label: "专区入口",
        text: "访问「关系经营」页面，按主题阅读已有文章首页预览，登录后解锁全文或投稿分享。",
      },
    ],
  },
  {
